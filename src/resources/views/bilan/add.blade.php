...
<div class="d-flex justify-content-between align-items-center mb-5">
    <h1 class="h3 mb-0 text-gray-800">Nouveau</h1>
...
<div class="shadow p-4 bg-white rounded">
    <form action="{{ route('bilan.post.add') }}" method="post">
        @csrf
        <div class="mb-4">
                    ...
                    <div class="mb-3">
                        ...
                        @foreach ($actifs as $actif)
                            <div class="row mb-3">
                                ...
                                <div class="col-6">
                                    <input value="{{ old('actif_' . $actif->id) }}" type="number" class="form-control" name="actif_{{ $actif->id }}" id="">
                                </div>
                    ...
                    <div class="mb-3">
                        ...
                        @foreach ($passifs as $passif)
                            <div class="row mb-3">
                                ...
                                <div class="col-6">
                                    <input value="{{ old('passif_' . $passif->id) }}" type="number" class="form-control" name="passif_{{ $passif->id }}">
                                </div>
